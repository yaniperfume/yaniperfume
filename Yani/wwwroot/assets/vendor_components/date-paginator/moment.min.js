! function(e, t) {
    ...
    var Te = "فروردین_اردیبهشت_خرداد_تیر_مرداد_شهریور_مهر_آبان_آذر_دی_بهمن_اسفند".split("_"),
        Ne = "فروردین_اردیبهشت_خرداد_تیر_مرداد_شهریور_مهر_آبان_آذر_دی_بهمن_اسفند".split("_"),
        Pe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        Re = de,
        We = de;
    ...
    var Ze = "شنبه_یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنجشنبه_جمعه".split("_"),
        ze = "شنبه_یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنجشنبه_جمعه".split("_"),
        $e = "شنبه_یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنجشنبه_جمعه".split("_"),
        qe = de,
        Be = de,
        Je = de;
    ...
    var Wt = ["سال", "فصل", "ماه", "هفته", "روز", "ساعت", "دقیقه", "ثانیه", "میلی ثانیه"];
    ...
    kn.calendar = function(e, t, n) {
        ...
        ordinal: function(e) {
            var t = e % 10;
            return e + (1 === Z(e % 100 / 10) ? " م " : 1 == t ? " م " : 2 == t ? " م " : 3 == t ? "م " : " ام ")
        }
