...
! function() {
    "use strict";
    var n, t, e, r = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        ...
        y = function(i, n, t, e, r, o) {
            i.ui.registry.addSplitButton(n, {
                ...
                select: function(t) {
                    var n, e, r;
                    return (e = (n = i).dom.getParent(n.selection.getNode(), "ol,ul"), r = n.dom.getStyle(e, "listStyleType"), d(r)).map(function(n) {
                        return t === n
                    }).getOr(!1)
                },
                onSetup: function(t) {
        ...
        v = function(n, t, e, r, i, o) {
            var u, l, s, c, a;
            0 < o.length ? y(n, t, e, r, i, o) : (l = t, s = e, c = r, a = i, (u = n).ui.registry.addToggleButton(l, {
                active: !1,
                tooltip: s,
